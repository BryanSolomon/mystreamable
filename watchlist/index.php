...
$querysearchfull = "SELECT name, objectID, season, episode, streamingService, type FROM listItems WHERE userID='".$_SESSION['userID']."' AND listID=2";
...
if(isset($_POST['button-search'])){
    ...
    $querysearch = "SELECT name, objectID, season, episode, streamingService, type FROM listItems WHERE name='".$title."' AND userID='".$_SESSION['userID']."' AND listID=2";
...
if(isset($_POST['button-filter'])){
    ...
    if($_POST['filter-itemType'] == "Movie"){
        $queryfilter = "SELECT name, objectID, season, episode, streamingService, type FROM listItems WHERE userID='".$_SESSION['userID']."' AND listID=2 AND type=1";
    }
    else if($_POST['filter-itemType'] == "TV Show"){
        $queryfilter = "SELECT name, objectID, season, episode, streamingService, type FROM listItems WHERE userID='".$_SESSION['userID']."' AND listID=2 AND type=2";
    }
    else if($_POST['filter-itemType'] == "All"){
        $queryfilter = "SELECT name, objectID, season, episode, streamingService, type FROM listItems WHERE userID='".$_SESSION['userID']."' AND listID=2";
    }
...
<head>
    <title>Watchlist | Streamable</title>
    <meta charset="utf-8" />
    ...
    <div class="w-100 text-white bg-dark hero d-flex flex-column mb-3 hero-size">
        <div class="w-100 h-100 darken bg-blur d-flex">
            <div class="container mt-auto mb-auto">
                <h1>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-bookmark hero-icon" viewBox="0 0 16 16">
                        ...
                        <div class="col-md-9">
                            ...
                            <?php
                                ...
                                if(mysqli_num_rows($result) == 0) {
                                    ?>
                                    <a id="<?php echo $obj?>-fav" class="btn btn-light mb-1 me-1" onclick="update(<?php echo $obj ?>,<?php echo $type?>,1,`<?php echo $obj?>-fav`,2);">
                                ...
                                $sql = "SELECT * FROM listItems WHERE userID = $userID AND objectID = '" . $obj . "' AND listID = 2";
                                $result = mysqli_query($conn, $sql);
                                    ?>
                                    <a id="<?php echo $obj?>-watch" class="btn btn-light mb-1 me-1" onclick="update(<?php echo $obj ?>,<?php echo $type?>,3,`<?php echo $obj?>-watch`);">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-collection-play btn-icons" viewBox="0 0 16 16">
                                        <path d="M2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3zm2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1zm2.765 5.576A.5.5 0 0 0 6 7v5a.5.5 0 0 0 .765.424l4-2.5a.5.5 0 0 0 0-.848l-4-2.5z"/>
                                        <path d="M1.5 14.5A1.5 1.5 0 0 1 0 13V6a1.5 1.5 0 0 1 1.5-1.5h13A1.5 1.5 0 0 1 16 6v7a1.5 1.5 0 0 1-1.5 1.5h-13zm13-1a.5.5 0 0 0 .5-.5V6a.5.5 0 0 0-.5-.5h-13A.5.5 0 0 0 1 6v7a.5.5 0 0 0 .5.5h13z"/>
                                    </svg>    
                                    <span class="btn-text">Mark Currently Watching</span>
                                    </a>
                                    <?php
                            ?>
